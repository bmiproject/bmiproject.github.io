...
export default {
	...
	data: () => ({
        ...
        socialMedia: [
            { icon: require('../../assets/facebook.png'), link: '#' },
            { icon: require('../../assets/twitter.png'), link: '#' },
            { icon: require('../../assets/linkedin.png'), link: '#' },
            { icon: require('../../assets/instagram.png'), link: '#' },
        ],
        navigateLinks: [
            { title: "Neque quam euismod ultrices", link: "#" },
            { title: "Orci ipsum iaculis", link: "#" },
            { title: "Suspendisse volutpat eget nibh", link: "#" },
            { title: "At sem quisque in posuere dignissim", link: "#" },
        ]
	}),
}
</script>
